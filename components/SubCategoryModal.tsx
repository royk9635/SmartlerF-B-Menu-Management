...
interface SubCategoryModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: Omit<SubCategory, 'id' | 'categoryId'>) => void;
    initialData: SubCategory | null;
    parentCategoryName: string;
}

const SubCategoryModal: React.FC<SubCategoryModalProps> = ({ isOpen, onClose, onSubmit, initialData, parentCategoryName }) => {
