...
const MenuItemList: React.FC<MenuItemListProps> = ({ category, items, onAddItem, onEditItem, onDeleteItem, onBack, onToggleAvailability, onImageClick, onOpenBulkActions }) => {
